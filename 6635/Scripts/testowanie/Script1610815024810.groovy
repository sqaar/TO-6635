...
WebUI.navigateToUrl('https://demosite.executeautomation.com/index.html#')

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Execute Automation/select_SelectMr.Ms'), '1', true)

WebUI.setText(findTestObject('Object Repository/Page_Execute Automation/input_Initial_Initial'), 'PO')

WebUI.setText(findTestObject('Object Repository/Page_Execute Automation/input__FirstName'), 'patryk')

WebUI.setText(findTestObject('Object Repository/Page_Execute Automation/input_Middle Name_MiddleName'), 'oleszczak')
